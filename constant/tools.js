export const TOOL_CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      {
        id: "extract-pdf-pages-tool",
        name: "Extract PDF Pages",
        path: "/tools/pdf-tools/extract-pdf-pages-tool",
      },
      {
        id: "high-resolution-tiff-to-pdf-converter",
      ...
      {
        id: "organize-pdf-tool",
        name: "Organize PDF",
        path: "/tools/pdf-tools/organize-pdf-tool",
      },
      {
        id: "pdf-to-bmp-converter",
      ...
      {
        id: "pdf-to-zip-converter",
        name: "PDF to ZIP",
        path: "/tools/pdf-tools/pdf-to-zip-converter",
      },
      {
        id: "png-to-pdf-converter",
    ...
    subcategories: [
      {
        ...
        tools: [
          {
            id: "acceleration-calculator-with-charts",
          ...
          {
            id: "magnitude-acceleration-calculator",
      ...
      },
      {
        ...
        tools: [
          {
            id: "advanced-fraction-calculator",
      ...
      },
      {
        ...
        tools: [
          {
            id: "401k-calculator-for-use-by-us-residents",
            name: "401(k) Calculator",
            path: "/tools/calculators/financial/401k-calculator-for-use-by-us-residents",
          },
          {
            id: "advance-debt-consolidation-calculator",
          ...
          {
            id: "simplified-sales-tax-calculator",
  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        tools: [
          {
            id: "amps-to-milliamps-converter",
          ...
          {
            id: "milliamps-to-amps-converter",
        ...
        tools: [
          {
            ...
            name: "Illumination Converter",
            path: "/tools/other-tools/illumination-converter",
          },
        ],
      },
      {
