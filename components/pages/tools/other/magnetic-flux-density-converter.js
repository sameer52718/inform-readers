...
const units = [
  { name: "Tesla [T]", tesla: 1 },
  { name: "Weber/square meter [Wb/m²]", tesla: 1 },
  { name: "Weber/square centimeter [Wb/cm²]", tesla: 10000 },
  { name: "Weber/square inch [Wb/in²]", tesla: 1550.0031000062 },
  { name: "Maxwell/square meter [Mx/m²]", tesla: 1 },
  { name: "Maxwell/square centimeter [Mx/cm²]", tesla: 0.0001 },
  { name: "Maxwell/square inch [Mx/in²]", tesla: 1.55e-5 },
  { name: "Gauss [Gs, G]", tesla: 0.0001 },
  { name: "Line/square centimeter [line/cm²]", tesla: 0.0001 },
  { name: "Line/square inch [line/in²]", tesla: 1.55e-5 },
  { name: "Gamma", tesla: 1.0e-9 },
];
...
export default function MagneticFluxDensityConverter() {
  ...
  const convertMagneticFluxDensity = () => {
    if (!inputValue) {
    ...
    try {
      const tesla = value * fromUnitData.tesla;
      const resultValue = tesla / toUnitData.tesla;
      let formattedResult;
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="bg-gray-100 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Magnetic Flux Density Converter</h2>
        <div className="space-y-4">
          ...
          <button
            onClick={convertMagneticFluxDensity}
