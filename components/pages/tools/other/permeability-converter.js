...
const units = [
  { name: "Kilogram/pascal/second/square meter [kg/Pa/s/m²]", kgPerPascalSecondSquareMeter: 1 },
  { name: "Permeability (0°C) [perm (0°C)]", kgPerPascalSecondSquareMeter: 5.72135e-11 },
  { name: "Permeability (23°C) [perm (23°C)]", kgPerPascalSecondSquareMeter: 5.74525e-11 },
  { name: "Permeability inches (0°C) [perm in (0°C)]", kgPerPascalSecondSquareMeter: 1.45322e-12 },
  { name: "Permeability inches (23°C) [perm in (23°C)]", kgPerPascalSecondSquareMeter: 1.45929e-12 },
];
...
export default function PermeabilityConverter() {
  ...
  const convertPermeability = () => {
    ...
    try {
      const kgPerPascalSecondSquareMeter = value * fromUnitData.kgPerPascalSecondSquareMeter;
      const resultValue = kgPerPascalSecondSquareMeter / toUnitData.kgPerPascalSecondSquareMeter;
      let formattedResult;
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="bg-gray-100 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Permeability Converter</h2>
