...
export default function Home() {
  ...
  const convertTablespoonsToTeaspoons = () => {
    ...
    if (!isNaN(tablespoonsValue)) {
      const teaspoons = tablespoonsValue * 3;
      setResult(`Result: ${tablespoonsValue} tablespoons = ${teaspoons.toFixed(3)} teaspoons`);
    } else {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-white">
      <div className="bg-gray-100 p-8 rounded-xl shadow-2xl text-center w-80">
        <h2 className="text-red-500 text-2xl mb-5">Tablespoons to Teaspoons</h2>
        <input
          type="number"
          value={tablespoons}
        ...
        />
        <button
          onClick={convertTablespoonsToTeaspoons}
