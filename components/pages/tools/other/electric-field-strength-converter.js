...
export default function Home() {
  ...
  const [toUnit, setToUnit] = useState("V/m");
  ...
  const toVM = {
    ...
    "mV/m": 0.001,
    "µV/m": 1.0e-6,
    "kV/in": 39370.078740157,
    "V/in": 39.3700787402,
    "V/mil": 39370.078740157,
    "abV/cm": 1.0e-6,
    "stV/cm": 29979.19999934,
    "stV/in": 11802.834645298,
    "N/C": 1,
  };

  const units = Object.keys(toVM);
  ...
  const convert = () => {
    ...
    if (!(fromUnit in toVM) || !(toUnit in toVM)) {
      setResult('<span className="text-red-500">Invalid unit selected</span>');
      return;
    }

    const resultValue = (value * toVM[fromUnit]) / toVM[toUnit];
  ...
  return (
    <div className="flex justify-center items-center  bg-white">
      <div className="bg-gray-100 p-5 rounded-lg shadow-lg w-full max-w-md">
        <h1 className="text-red-500 text-2xl text-center mb-5">Electric Field Strength Converter</h1>
        <div className="mb-4">
