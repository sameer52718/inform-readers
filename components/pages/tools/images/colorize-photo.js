...
const ColorizePhoto = () => {
  ...
  const processImage = async () => {
    ...
    try {
      ...
      setResult(
        <a href={dataUrl} download="colorized_image.png" className="text-red-600 hover:underline">
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto space-y-6">
          <h1 className="text-3xl font-bold text-gray-900 text-center mb-6">Colorize Photo</h1>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="controls">
              <label className="block text-sm font-medium text-gray-700">Tint Color</label>
              <input
                type="color"
                value={tintColor}
