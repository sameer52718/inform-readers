...
import { ArrowRight, Building2, ChevronRight, Globe2, MapPin } from "lucide-react";
...
const getData = async (host) => {
  try {
    const res = await axiosInstance.get("/website/home", { params: { host } });
          ...
          <section className="py-16">
            <div className="bg-white rounded-2xl shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {data.postalCodeState.map((state) => (
                  <div
                    key={state.stateSlug}
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h2 className="text-xl font-semibold text-gray-900">{state._id}</h2>
                    </div>
                ...
                {data.randomBanks.map((bank) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h2 className="text-xl font-semibold text-gray-900">{bank._id}</h2>
                    </div>
