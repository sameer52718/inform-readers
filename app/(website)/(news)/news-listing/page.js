...
const NewsSection = () => {
  ...
  return (
    <div className="bg-gray-200 md:p-6 rounded-3xl border border-black mb-6">
      {newsData.map((news) => (
        <div key={news.id} className="flex flex-col sm:flex-row space-x-4 sm:space-x-6 p-4 rounded-xl mb-6">
          {/* Image */}
...
function NewsListing() {
  return (
    <div className="container mx-auto">
      ...
      <div className=" py-8">
        <h4 className="font-bold text-4xl text-center md:mb-0 mb-5">
          <span className="text-red-500">Fashion</span> News
        </h4>
        <Gallery />
      </div>
