            ...
            {[...Array(5)].map((_, i) => (
              <div key={5 - i} className="flex items-center space-x-2">
                ...
                <div className="w-full bg-gray-300 h-3 md:h-4 rounded-full">
                  {ratings[i] > 0 && (
                    <div
                      className="bg-red-600 h-3 md:h-4 rounded-full"
            ...
            className={`px-3 py-2 font-bold text-base md:text-lg transition-all duration-200 
                ${
                  selectedReviewTab === tab
                    ? "text-red-600 font-bold bg-gray-300 rounded-2xl"
                    : "text-gray-500"
                }
              `}
        ...
        {articles.map((article) => (
          ...
          >
            ...
            <div className="p-3 flex-1">
              {/* Category */}
              <span className="text-white text-xs bg-red-500 px-2 py-1 rounded-lg">{article.category}</span>
...
function NewsDetail() {
  return (
    <div className="container mx-auto">
      <AdBanner />
      <div className="py-8">
        <h4 className="md:text-3xl text-2xl font-bold mb-6">
          <span className="text-red-500"> News Magazine </span> Charts the Most Chic and Fashionable Women of
          New York City
        </h4>
        ...
        <p className="md:text-xl font-semibold mb-5">
          We woke reasonably late following the feast and free flowing wine the night before. After gathering
          ourselves and our packs, we headed down to our homestay family’s small dining room for breakfast.
        </p>
        <p className="md:text-xl font-semibold mb-5">
        ...
        <p className="md:text-xl font-semibold mb-5">
          We were making our way to the Rila Mountains, where we were visiting the Rila Monastery where we
          enjoyed scrambled eggs, toast, mekitsi, local jam and peppermint tea.
        </p>
        ...
        <div className="grid md:grid-cols-3 grid-cols-1 gap-10">
          <div className="md:col-span-2">
            <p className="text-xl font-semibold mb-5">
              I had low expectations about Sofia as a city, but after the walking tour I absolutely loved the
              place. This was an easy city to navigate, and it was a beautiful city – despite its ugly,
              staunch and stolid communist-built surrounds. Sofia has a very average facade as you enter the
              city, but once you lose yourself in the old town area, everything changes.
            </p>
            <p className="text-xl font-semibold mb-5">
        ...
        <div className="px-2">
          ...
          <p className="text-lg font-semibold">
            Clothes can transform your mood and confidence. Fashion moves so quickly that, unless you have a
            strong point of view, you can lose integrity. I like to be real. I don’t like things to be staged
            or fussy. I think I’d go mad if I didn’t have a place to escape to. You have to stay true to your
            heritage, that’s what your brand is about.
          </p>
