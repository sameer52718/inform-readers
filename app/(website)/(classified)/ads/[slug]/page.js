  ...
  return (
    <div className="container mx-auto">
      ...
      <div className=" bg-white">
        <div className=" py-4 sm:py-6 flex flex-wrap items-center gap-1 text-sm sm:text-base">
          <h6>Home</h6>
          <span>/</span>
          <h6>Electronics</h6>
          <span>/</span>
              ...
              <div className="flex items-center space-x-4 sm:space-x-6 md:space-x-10 overflow-x-auto">
                ...
                <div className="flex gap-2 sm:gap-4">
                  {images.map((img, index) => (
                    <div
                      key={index}
                      className={`border-2 p-1 rounded-2xl cursor-pointer ${
                        selectedImage === img ? "border-red-500" : "border-black"
                      }`}
            ...
            <div className="bg-white p-6 sm:p-10 grid grid-cols-1 sm:grid-cols-12 rounded-3xl gap-4 sm:gap-0">
              ...
              <div className="sm:col-span-9 flex flex-col sm:flex-row gap-4 sm:gap-3">
                ...
                <div className="text-center sm:text-left">
                  <h4 className="text-xl sm:text-2xl font-bold mb-2">Seller Information</h4>
        ...
        <div>
          ...
          <div className="mt-12 px-4 sm:px-0">
            <p className="mb-4 font-semibold text-base sm:text-lg leading-relaxed">
              ...
              labore et dolore magna aliqua. In eu mi bibendum neque egestas congue quisque.
            </p>
            <p className="mb-4 font-semibold text-base sm:text-lg leading-relaxed">
              At urna condimentum mattis pellentesque id nibh tortor. Aliquam eleifend mi in nulla posuere.
              Sed sed risus pretium quam vulputate. Sit amet dictum sit amet justo donec enim diam vulputate.
            </p>
            <p className="mb-4 font-semibold text-base sm:text-lg leading-relaxed">
