    ...
    <div className="bg-white rounded-2xl flex flex-col sm:flex-row p-6 sm:p-8 gap-6 sm:gap-8 mb-5">
      ...
      <div className="relative flex flex-col sm:flex-row gap-4 w-full">
        <div className="flex-1">
          <h4 className="text-2xl sm:text-4xl font-semibold mb-2">HD Camera 5100</h4>
        ...
        <div className="sm:pl-10 flex flex-col justify-end items-center sm:items-start">
          <p className="text-xl sm:text-2xl font-semibold mb-1">$100</p>
          <Link href={"ads/12"}>
  ...
  return (
    <div className="mx-auto container">
      ...
      <div className=" py-8">
        ...
        <div className="flex justify-center">{/* <Pagination currentPage={1} totalPages={10} /> */}</div>
      </div>
    </div>
  );
}
