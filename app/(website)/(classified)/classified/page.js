    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 p-4 mt-10">
            <div className='flex items-center gap-3'>
                <div className='w-[50%]'>
                    <Image src={"/website/assets/images/location/01.png"} width={500} height={500} alt='grid-image' className='w-full h-72 object-cover' />
                </div>
                <div className='w-[50%]'>
                    <Image src={"/website/assets/images/location/02.png"} width={500} height={500} alt='grid-image' className='w-full h-72 object-cover' />
                </div>
            </div>
            <div>
                <Image src={"/website/assets/images/location/03.png"} width={500} height={500} alt='grid-image' className='w-full h-72 object-cover' />
            </div>
            <div>
                <Image src={"/website/assets/images/location/04.png"} width={500} height={500} alt='grid-image' className='w-full h-72 object-cover' />
            </div>
            <div>
                <Image src={"/website/assets/images/location/05.png"} width={500} height={500} alt='grid-image' className='w-full h-72 object-cover' />
            </div>
        </div>
    );
}
    ...
    return (
        <div>
            ...
            <div className='px-32 py-8' >
                ...
                <div className='mt-10'>
                    <h4 className='text-3xl text-[#ff0000] text-center underline font-bold mb-8'>
                        POPULAR CATEGORIES
                    </h4>
                    ...
                    <div className='flex items-center justify-center'>
                        <button className='rounded-2xl border text-center border-red-500 px-6 text-red-500 text-lg py-2 bg-white mt-8 font-semibold'>
                            Browse All Jobs <Icon icon="basil:caret-down-outline" width="24" height="24" className="inline" />
                        </button>
                    </div>
                ...
                <div className='mt-10'>
                    ...
                    <div className='flex items-center justify-center'>
                        <button className='rounded-2xl border text-center border-red-500 px-6 text-red-500 text-lg py-2 bg-white mt-8 font-semibold'>
                            See All Sectors <Icon icon="basil:caret-down-outline" width="24" height="24" className="inline" />
                        </button>
                    </div>
