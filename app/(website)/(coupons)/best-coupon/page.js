    ...
    <div className="border rounded-2xl border-black p-4 flex items-center justify-center h-[270px] flex-col bg-white gap-3">
      <Link href={"#"}>
        <Image
          ...
          height={1000}
          alt="product"
          className="h-28  w-32 rounded-2xl object-contain"
        />
      </Link>
      <div className="divider h-[1px] w-full bg-black"></div>
      <h6 className="text-lg text-gray-500 font-semibold line-clamp-2">
        <Link href={"#"}> {data?.name} </Link>
      </h6>
      <button className="px-5 py-2 bg-[#ff0000] text-white rounded-3xl">
        <Link href={"#"}>Cash Back</Link>
      </button>
    </div>
  );
};
...
function BestCoupons() {
  return (
    <div className="container mx-auto">
      ...
      <div className=" py-6">
        <h4 className="text-[#ff0000] text-4xl font-bold text-center">
          {" "}
          <span className="text-black">Best</span> Coupons Deal & Cash Back
        </h4>

        <div className="flex md:flex-row flex-col-reverse items-center justify-between mt-6">
          <div className="flex items-center gap-12 md:py-0 py-3 ">
            <h6 className="text-[#ff0000] font-bold md:text-xl text-sm ">Coupons Code</h6>

            <div className="flex items-center gap-6 md:text-xl text-sm">
      ...
      <div className=" py-6">
        <div className="flex md:flex-row flex-col-reverse items-center justify-between mt-6">
          <div className="flex items-center gap-12 md:py-0  py-3">
            <h6 className="text-[#ff0000] font-bold md:text-xl text-sm">Top Deals</h6>
      ...
      <div className=" py-6">
        <div className="flex md:flex-row flex-col-reverse  items-center justify-between mt-6">
          <div className="flex items-center gap-12 md:py-0 py-3 ">
            <h6 className="text-[#ff0000] font-bold md:text-xl text-sm  ">Cash Back</h6>
