    ...
    return (
        <div>
            ...
            <div className='container mx-auto px-44'>
                ...
                <h4 className='text-center text-5xl text-red-500 font-semibold'>
                    POPULAR JOB CATEGORIES
                </h4>
                <div className='grid grid-cols-3 gap-8 mt-8 bg-[#d9d9d9] rounded-3xl p-8'>
                    <div>
                ...
                <h4 className='text-center text-5xl text-red-500 font-semibold my-10'>
                    TOP SECTORS
                </h4>

                <div className='bg-[#d9d9d9] p-4 grid grid-cols-3 gap-12 mt-8 rounded-2xl'>
