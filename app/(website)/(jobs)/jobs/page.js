...
function Jobs() {
  return (
    <div className="container mx-auto">
      ...
      <div className=" ">
        <h4 className="text-center md:text-5xl text-xl text-red-500 font-semibold">POPULAR JOB CATEGORIES</h4>
        ...
        <h4 className="text-center md:text-5xl text-2xl text-red-500 font-semibold my-10">TOP SECTORS</h4>
        ...
        <div className="bg-[#d9d9d9] p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mt-8 rounded-2xl">
          <div className="bg-white rounded-xl flex items-center justify-center flex-col p-6">
            <Image
              src={"/website/assets/images/jobs/01.png"}
              width={1000}
              height={1000}
              alt="sector-logo"
              className="h-28 w-28"
          ...
          <div className="bg-white rounded-xl flex items-center justify-center flex-col p-6">
            <Image
              src={"/website/assets/images/jobs/02.png"}
              width={1000}
              height={1000}
              alt="sector-logo"
              className="h-28 w-28"
          ...
          <div className="bg-white rounded-xl flex items-center justify-center flex-col p-6">
            <Image
              src={"/website/assets/images/jobs/03.png"}
              width={1000}
              height={1000}
              alt="sector-logo"
              className="h-28 w-28"
          ...
          <div className="bg-white rounded-xl flex items-center justify-center flex-col p-6">
            <Image
              src={"/website/assets/images/jobs/04.png"}
              width={1000}
              height={1000}
              alt="sector-logo"
              className="h-28 w-28"
          ...
          <div className="bg-white rounded-xl flex items-center justify-center flex-col p-6">
            <Image
              src={"/website/assets/images/jobs/05.png"}
              width={1000}
              height={1000}
              alt="sector-logo"
              className="h-28 w-28"
          ...
          <div className="bg-white rounded-xl flex items-center justify-center flex-col p-6">
            <Image
              src={"/website/assets/images/jobs/06.png"}
              width={1000}
              height={1000}
              alt="sector-logo"
              className="h-28 w-28"
