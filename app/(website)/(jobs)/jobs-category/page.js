    ...
    return (
        <div className="border rounded-2xl p-8 bg-gray-200 w-full">
            ...
            <div className="bg-gray-50 p-4 rounded-lg  mt-3">
                <p className="font-bold">No Record <span className="text-red-500">Sorry!</span></p>
                <p className="text-sm text-gray-600">Does not match record with your keyword. Change your filter keywords to resubmit.</p>
