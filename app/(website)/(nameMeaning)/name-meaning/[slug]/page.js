  ...
  return (
    <div className="container mx-auto">
          ...
          <div className="flex items-center justify-center my-6">
            <buttom className="py-2 px-6 bg-[#d9d9d9] text-[#ff0000] rounded-3xl border border-[#000]  w-fit">
              <Link href={"#"} className="flex items-center font-semibold text-lg">
                ...
                <Icon icon="ri:arrow-right-double-line" width="28" height="28" className="mt-1" />
              </Link>
            </buttom>
          </div>
        </div>
      ...
      <div className=" py-8">
        ...
        <h4 className="text-xl sm:text-2xl  font-semibold my-5">What is the Meaning of Kabir?</h4>

        <p className="text-base sm:text-lg  font-semibold">
          Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        </p>

        <h4 className="text-xl sm:text-2xl  font-semibold my-5">What is the name length of Kabir?</h4>

        <p className="text-base sm:text-lg  font-semibold">
          Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        </p>

        <h4 className="text-xl sm:text-2xl  font-semibold my-5">What is the lucky number of Kabir?</h4>
