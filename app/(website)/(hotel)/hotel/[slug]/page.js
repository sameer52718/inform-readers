    ...
    return (
        <div>
            ...
            <div className='container mx-auto px-44 py-8'>
                <div className="flex items-center justify-between bg-gray-100 p-4 rounded-lg w-full ">
                    <div>
                        <h2 className="text-3xl font-bold mb-1">Sheraton Grand Hotel, Dubai</h2>
                    ...
                    <div className='flex items-center justify-center flex-col'>
                        <span className="text-2xl mb-2 font-bold ">$164</span>
                ...
                <div className="p-4 ">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex items-center space-x-2 mt-2">
                            <button className="flex items-center space-x-1 bg-gray-200 px-3 py-2 rounded-md">
                        ...
                        <div className="bg-gray-200 p-4 rounded-lg">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm">Delux room</p>
                                </div>
                ...
                {[...Array(2)].map((_, index) => (
                    <div className="bg-gray-200 p-4 rounded-lg  mt-5">
                        ...
                        <div className="flex justify-between items-center mb-2">
                            <h3 className="text-lg font-bold">Delux Guest Room</h3>
                        </div>
                ...
                <h4 className='mt-5 font-bold text-3xl mb-3'>The neighborhood - Trade Centre</h4>
