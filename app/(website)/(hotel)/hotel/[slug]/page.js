  ...
  return (
    <div className="px-6 py-10 bg-white  rounded-lg">
      ...
      <div className="flex items-center justify-center mt-4">
        <button className="w-fit px-10 py-3 rounded-3xl bg-red-600 text-white hover:bg-red-700">
          Write a Review
        </button>
      </div>
    </div>
      ...
      <div className="  py-8">
        ...
        <div className="p-4">
          ...
          <div>
            ...
            <button className="mt-2 bg-red-600 text-white px-3 py-1 text-sm rounded-md">Read More</button>
          </div>
          ...
          {[...Array(2)].map((_, index) => (
            <div key={index} className="bg-gray-200 p-4 rounded-lg">
              ...
              <div className="flex justify-between  items-center mt-4">
                ...
                <button className="bg-red-600 text-white px-4 py-2 text-sm rounded-lg">View Deal</button>
              </div>
            </div>
          ))}
        </div>
              ...
              <div className="w-full space-y-3">
                ...
                <div className="flex justify-between items-center border-b border-black pb-1">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button className="bg-red-600 text-white px-3 py-1 text-sm rounded-lg">View Deal</button>
                  </div>
                </div>
                ...
                <div className="flex flex-col border-b pb-1">
                  <span className="text-red-600 text-sm font-medium">Member Rate Available</span>
                  <span className="text-gray-600 text-sm">Marriott Bonvoy Rate Available Free Sign-up</span>
                ...
                {/* Show More Deals */}
                <button className="text-red-600 text-sm font-medium mt-2">Show 2 more deals</button>
              </div>
            </div>
          </div>
        ))}
        ...
        <div className="p-6  text-black mt-10">
                ...
                <div key={index} className="flex items-center justify-between text-sm mb-1">
                  ...
                  <div className="bg-gray-300 w-40 h-2 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${(rating.value / 1608) * 100}%` }}
                    ></div>
                  </div>
          ...
          <div className="bg-gray-200 p-4 rounded-md mt-4">
            ...
            <p className="text-sm mt-2">
              Guests had mixed experiences at the hotel. While many praised the cleanliness and overall value
              for the price, with several highlighting the good location as a positive aspect, there were
              notable complaints about the service and check-in process, which many found to be slow and
              unorganized. Despite these issues, some guests enjoyed their stay, particularly appreciating the
              friendly staff and spacious accommodations.
            </p>
          </div>
        </div>
