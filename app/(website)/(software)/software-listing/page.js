            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
                {appData[activeTab].map((app, index) => (
                    ...
                    >
                        ...
                        <p className="font-semibold text-lg md:text-xl text-center mt-3">
                            {app.name}
                        </p>
...
function SoftwareListing() {
    return (
        <div>
            <AdBanner />
            <div className='md:px-48 px-4 bg-white pb-6'>
            ...
            <div className='md:px-40 py-8'>
                <div className="grid grid-cols-12 gap-6 md:gap-12 md:px-0 px-4">
                    ...
                    <div className="md:col-span-9 col-span-12">
                        ...
                        <div>
                            <h4 className="text-lg md:text-2xl font-bold text-red-500 mb-4">
                                Best Games Software:
                            </h4>
                            <TabMenu />
