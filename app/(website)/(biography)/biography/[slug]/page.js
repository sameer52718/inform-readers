...
function BiographyDetail() {
    return (
        <div className='container mx-auto'>
            <AdBanner />
            <section className="px-4 md:px-12 lg:px-24 xl:px-36 bg-white">
                <div className="flex flex-wrap items-center gap-1 px-4 md:px-12 lg:px-24 py-4 md:py-6">
                    <h6>Home</h6>
            ...
            <section className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-48 py-6 md:py-8">
                    ...
                    <div className="md:col-span-2 p-4 md:p-6">
                        <div className="bg-[#d9d9d9] px-4 pt-4 pb-4 border border-black rounded-xl w-full shadow-md grid grid-cols-1">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                                {Array(3).fill("/website/assets/images/specifacationCard/game/icon-4.png").map((icon, index) => (
                                    <div key={index} className="flex items-center gap-2">
                                        <Image src={icon} alt="icon" width={1000} height={1000} className="w-10 h-10" />
                                        <span className="text-gray-600 text-sm sm:text-base">
                                            Modes: Single-player, Multiplayer
            ...
            <div className="px-4 sm:px-6 md:px-12 lg:mx-24 xl:mx-56 flex flex-wrap items-center justify-between bg-red-600 text-white py-3 text-sm font-bold mb-8">
                <h5 className="text-lg sm:text-xl md:text-2xl lg:text-3xl ml-2">
                    Dilraba Dilmurat
                </h5>
