    ...
    <div className="container mx-auto">
      ...
      <div className=" py-8">
        ...
        <div className="bg-[#C1C1C1] flex flex-wrap items-center my-5 justify-between py-4 px-4 rounded-lg">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-white">Pakistan Weather Radar</h3>
        ...
        <div className="border-black border rounded-lg py-6 px-6 sm:px-10 lg:px-16 bg-white mt-4">
          ...
          <div className="border-b border-black pb-4 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
            <Image
              src={"/website/assets/images/weather/02.png"}
              width={1000}
              height={1000}
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left mt-4">
            <Image
              src={"/website/assets/images/weather/03.png"}
              width={1000}
              height={1000}
              className="w-16 sm:w-20 h-16 sm:h-20"
            />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-10 mt-4 bg-white px-6 sm:px-12 lg:px-20 py-8 sm:py-12 rounded-3xl border border-black">
            ...
            <div className="flex flex-col items-center sm:items-start">
              <div className="flex items-center gap-4">
                <Image
                  src={"/website/assets/images/weather/sky-1.png"}
                  width={1000}
                  height={1000}
              ...
              <div className="text-center sm:text-left mt-4">
                ...
                <h6 className="text-base sm:text-xl font-semibold text-blue-600 cursor-pointer">
                  More Details
                </h6>
              </div>
            </div>
        ...
        <div className="mt-8">
          ...
          <div className="border border-black grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 mt-8 bg-white p-4 sm:p-6 lg:p-12 rounded-3xl gap-4 sm:gap-6 lg:gap-10">
            {weatherData.map((item, index) => (
              <div
                key={index}
                className="bg-[#d4d4d4] col-span-1 sm:col-span-1 lg:col-span-6 flex items-center justify-between p-4 sm:p-6 rounded-xl"
              >
                <div>
        ...
        <div className="my-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-10 mt-4 bg-gray-300 p-4 sm:p-8 lg:p-12 rounded-3xl border border-black">
            <div className="col-span-1 flex flex-col">
              <div className="flex items-center gap-4">
                <Image
                  src={"/website/assets/images/weather/04.png"}
                  width={1000}
                  height={1000}
                  className="w-24 h-24 sm:w-36 sm:h-36 lg:w-48 lg:h-48"
                />
                <div>
            ...
            <div className="col-span-1 flex flex-col items-center sm:items-end justify-center">
              <div>
                ...
                <h6 className="font-bold text-lg sm:text-xl lg:text-2xl">
                  {" "}
                  <span className="text-[#ff0000]">Set</span> 5:32 PM
                </h6>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-10 mt-4 bg-gray-300 p-4 sm:p-8 lg:p-12 rounded-3xl border border-black">
            <div className="col-span-1 flex flex-col">
              <div className="flex items-center gap-4">
                <Image
                  src={"/website/assets/images/weather/05.png"}
                  width={1000}
                  height={1000}
                  className="w-24 h-24 sm:w-36 sm:h-36 lg:w-48 lg:h-48"
                />
