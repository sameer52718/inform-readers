      ...
      <div className=" py-8">
        ...
        <div>
          <div className=" p-6">
            ...
            <ul className="list-decimal pl-6 text-lg">
              <li>
                ...
                <ul className="list-disc pl-6 text-base">
                  <li>
                    Represents the <span className="text-red-500 font-bold">region</span> or{" "}
                    <span className="text-red-500 font-bold">state</span>.
                  </li>
                  <li>
                    Example: "A" could mean the <span className="text-red-500 font-bold">North Zone</span>.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className="list-disc pl-6 text-base">
                  <li>
                    Specifies a <span className="text-red-500 font-bold">sub-region</span> within the main
                    region.
                  </li>
                  <li>
                    Example: "1" might identify a{" "}
                    <span className="text-red-500 font-bold">specific province or city</span>.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className="list-disc pl-6 text-base">
                  <li>
                    Refines the area further, identifying a{" "}
                    <span className="text-red-500 font-bold">district or zone</span>.
                  </li>
                  <li>
                    Example: "B" could represent a specific{" "}
                    <span className="text-red-500 font-bold">sector or neighborhood</span>.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className="list-disc pl-6 text-base">
                  <li>
                    Indicates the local delivery unit or{" "}
                    <span className="text-red-500 font-bold">postal sector</span>.
                  </li>
                  <li>
                    Example: "2" might refer to a{" "}
                    <span className="text-red-500 font-bold">postal office branch in the area</span>.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul className="list-disc pl-6 text-base">
                  <li>
                    Further pinpoints a specific location, such as a{" "}
                    <span className="text-red-500 font-bold">street, block, or building</span>.
                  </li>
              ...
              <li>
                ...
                <ul className="list-disc pl-6 text-base">
                  <li>
                    Adds extra precision, like an{" "}
                    <span className="text-red-500 font-bold">apartment, suite, or floor</span>.
                  </li>
                  <li>
                    Example: "456" could represent{" "}
                    <span className="text-red-500 font-bold">Suite 456 in Building 3</span>.
                  </li>
                </ul>
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-base">
              <li>
                <span className="text-red-500 font-bold">A</span> = Region (North Zone)
              </li>
              <li>
                <span className="text-red-500 font-bold">1</span> = Sub-region (City A)
              </li>
              <li>
                <span className="text-red-500 font-bold">B</span> = District (Neighborhood B)
              </li>
              <li>
                <span className="text-red-500 font-bold">2</span> = Local delivery office
              </li>
              <li>
                <span className="text-red-500 font-bold">C3</span> = Specific street/block (e.g., Elm Street,
                Block 3)
              </li>
              <li>
                <span className="text-red-500 font-bold">456</span> = Apartment/Suite (e.g., Suite 456)
              </li>
            </ul>
          </div>
        </div>
