        ...
        <div className='container mx-auto'>
            ...
            <div className='md:px-44 px-4 py-8'>
                <div className="px-4 sm:px-8 md:px-12 lg:px-16">
                    ...
                    <div className="bg-[#d9d9d9] py-6 sm:py-8 px-4 sm:px-8 md:px-12 rounded-3xl overflow-x-auto">
                        <table className="w-full bg-white rounded-lg overflow-hidden">
                            <thead>
                                <tr className="bg-gray-200 text-left">
                                    <th className="py-3 px-4 sm:px-6 text-sm sm:text-lg font-bold">Airport</th>
                ...
                <div className="px-4 sm:px-8 md:px-12 lg:px-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 w-full gap-4 mb-16">
                        {[
                            "Air Arabic", "PIA", "TH", "Emirates", "Flydubai",
                            "Air China", "American Airline", "Salam Air", "Air Blue",
                            "Kam Air", "Turkish Airlines", "Oman Air"
                        ].map((item, index) => (
                            <div
                                key={index}
