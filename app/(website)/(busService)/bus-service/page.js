    ...
    <div className="container mx-auto">
      ...
      <div className="py-8">
        ...
        <div className="text-center px-4 sm:px-8">
          ...
          <p className="text-base sm:text-lg text-red-500 font-semibold">Last Updated: 10th January 2025</p>
        </div>
          ...
          <div className="bg-[#d9d9d9] py-6 sm:py-8 px-4 sm:px-8 md:px-4 rounded-3xl">
            {Array(8)
              ...
              .map((_, index) => (
                <div
                  key={index}
                  className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-0 bg-white py-3 px-6 sm:px-8 mb-3 rounded-lg shadow"
                >
                  ...
                  <h5 className="text-sm sm:text-lg font-semibold text-black break-all">
                    <a href="https://daewoo.com.pk/" className="text-blue-600 underline">
                      https://daewoo.com.pk/
                    </a>
                  </h5>
                </div>
        ...
        <div>
          ...
          <div className="py-5 px-4 rounded-3xl">
            {["Lahore", "Faisalabad", "Multan", "Karachi"].map((item) => (
              <div
                key={item}
                className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-white py-4 px-6 mb-3 rounded-lg shadow"
              >
                {/* Location */}
