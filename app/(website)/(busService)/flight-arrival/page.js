...
function FlightArrival() {
  return (
    <div className="container mx-auto">
      ...
      <div className=" py-8">
        <div className="">
          <h4 className="text-xl sm:text-3xl font-bold my-3 text-center sm:text-left">Latest Comments</h4>
                ...
                <div key={index} className="mb-5">
                  <div className="bg-white p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3 rounded-2xl shadow-sm">
                    ...
                    <p className="text-base sm:text-xl font-semibold">
                      Unexpectedly, Bahawalpur Airport is so good at services. For my flight timings, I prefer
                      this page. It is very accurate.
                    </p>
                  </div>
