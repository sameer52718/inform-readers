            ...
            {currencies.map((currency) => (
              <tr key={currency.code} className="bg-white border-t">
                ...
                {currency.rates.map((rate, index) => (
                  <td key={index} className="p-2 text-center whitespace-nowrap">
                    {rate}
                  </td>
                ))}
              </tr>
...
function CurrencyConverter() {
  ...
  return (
    <div className=" py-6 sm:py-8 bg-gray-200 rounded-2xl">
      {/* Responsive Grid */}
    ...
    <div className="container">
      ...
      <div className=" py-8  mx-auto">
        ...
        <div className="text-center py-8 sm:py-10 max-w-[800px] w-full mx-auto px-4">
          <h4 className="text-xl sm:text-2xl font-bold mb-1">Waiting on a better rate?</h4>
          <p className="text-base sm:text-lg font-semibold">
            Set an alert now, and we’ll tell you when it gets better. And with our daily summaries, you’ll
      ...
      <div className=" py-8  mx-auto">
        ...
        <div className="py-10 px-2 sm:px-8 max-w-[900px] ">
          <h4 className="text-2xl sm:text-3xl font-bold mb-3">Compare prices for sending money abroad</h4>
