...
function GoldComparisonTable() {
  return (
    <div className="py-8">
      <h2 className="text-3xl font-bold  mb-4 px-2">24 Carat and 22 Carat Gold: Know the Difference</h2>
        ...
        <table className="w-full border  text-left p-4 rounded-xl overflow-hidden">
          ...
          <tbody className="bg-white">
            <tr className="border">
              ...
              <td className="p-3 border">
                It has 91.6% parts of pure gold. Rest of the parts are metals such as silver, copper, or some
                others.
              </td>
            </tr>
            <tr className="border">
              ...
              <td className="p-3 border">
                It has a hard texture and thus cannot be easily moulded or bended.
              </td>
            </tr>
            ...
            <tr className="border">
              ...
              <td className="p-3 border">It is usually tainted due to the presence of other metals.</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div className="p-6 bg-gray-300 rounded-2xl">
      ...
      <div className="space-y-3">
        {cities.map((row, rowIndex) => (
          <div
            key={rowIndex}
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 bg-white p-3 rounded-lg shadow-sm"
          >
    ...
    <div className="container  mx-auto">
      ...
      <div className=" py-8 ">
        ...
        <div className="relative py-10">
          <h4 className="md:text-5xl text-2xl md:mt-0 mt-10 text-center font-bold ">
        ...
        <div className="my-16">
          ...
          <GoldRateTable />
          <p className="text-lg font-semibold mt-5 px-5">
      ...
      <div className=" py-8 ">
        <GoldRateCalculator />
        <div className="py-10">
          <h4 className="font-semibold text-3xl mb-4">Know About Gold Price</h4>
        ...
        <GoldComparisonTable />
        <div className="py-6">
          <h4 className="font-bold text-3xl mb-4">Know About Gold Price</h4>
      ...
      <div className=" py-8 ">
        <GoldRatesCitywise />
        <div className="py-6">
          <h4 className="font-bold text-2xl sm:text-3xl mb-4">Gold Weight Conversion Table</h4>
          <p className="text-lg mb-4">
            Refer to the following table to find out the value of gold in different units. Gold is often
            measured in grams, kilograms, troy ounce, bhats, and tonnes.
          </p>
