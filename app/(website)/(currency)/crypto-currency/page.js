        ...
        <tbody className="block md:table-row-group">
          {cryptoData.map((coin, index) => (
            <tr key={index} className="bg-white border-t block md:table-row mb-4 md:mb-0">
              ...
              {/* Change (24h) */}
              <td className="p-2 md:p-3 text-sm md:text-lg block md:table-cell">
                <span className="md:hidden font-semibold">Change (24h): </span>
                {coin.change}
              </td>

              {/* Market Cap */}
              <td className="p-2 md:p-3 text-sm md:text-lg block md:table-cell">
                <span className="md:hidden font-semibold">Market Cap: </span>
                {coin.marketCap}
              </td>

              {/* Volume (24h) */}
              <td className="p-2 md:p-3 text-sm md:text-lg block md:table-cell">
                <span className="md:hidden font-semibold">Volume (24h): </span>
                {coin.volume}
              </td>
            </tr>
          ))}
    ...
    <div className="container">
        ...
        <div className="px-4">
          ...
          <div className="mb-6">
            <h4 className="text-xl sm:text-2xl font-bold leading-tight">
              Cryptocurrency Prices in India Today: Compare Bitcoin, Ethereum, Dogecoin, Litecoin, Ripple
              Prices Across CoinSwitch, Coinbase, WazirX, and Other Major Exchanges
            </h4>
      ...
      <div className=" py-4  mx-auto">
        <div className="bg-white border border-black p-8 rounded-2xl ">
          ...
          <p className="text-lg font-bold mb-4">
            Lorem Ipsum is simply dummy text of the printing of type and scrambled it to make a type specimen
            book.
          </p>
        </div>
        ...
        <div className="px-4">
          ...
          <div className="bg-[#d9d9d9] border border-black p-4 sm:p-6 md:p-8 rounded-2xl">
            ...
            <p className="text-base sm:text-lg font-bold mb-4">
              Lorem Ipsum is simply dummy text of the printing of type and scrambled it to make a type
              specimen book.
            </p>
          </div>
        </div>
